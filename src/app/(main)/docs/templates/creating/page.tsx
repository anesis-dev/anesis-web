...
├── oxide.template.json   ← required manifest
...
const manifestFields = [
	...
	},
	{
		...
		description:
			"The GitHub URL where this template lives. Can be a repo root or a subdirectory path — this is the same URL passed to `oxide template publish`.",
	},
	{
...
// src/main.ts.tera
// {{ project_name }} — generated by Oxide
		...
		<div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-5 py-10 lg:px-8">
			...
			<div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Oxide decides at generation time whether to render or copy each file.
						</CardDescription>
					</CardHeader>
			...
			<Card>
				<CardHeader className="gap-3">
					...
					<div>
						<CardTitle>The oxide.template.json manifest</CardTitle>
						<CardDescription>
				...
				<CardHeader className="gap-3">
					...
					<div>
						...
						<CardDescription>
							...
							<code className="rounded bg-muted px-1 py-0.5 font-mono text-xs">
								oxide new test-project my-template
							</code>{" "}
