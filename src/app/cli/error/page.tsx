...
export default function CliError() {
	return (
		<div className="flex min-h-dvh w-full items-center justify-center bg-[#0f0f0f] px-4 py-10 sm:px-6">
			<div className="flex w-full max-w-lg flex-col items-center justify-center gap-4 rounded-2xl bg-[#1a1a1a] px-6 py-8 text-center animate-[fadeIn_.6s_ease-out,errorGlow_1.2s_ease-out_.3s_forwards] sm:px-10 sm:py-10">
